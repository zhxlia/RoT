...
if __name__ == "__main__":
    ...
    # for part in ['train', 'test']:
    #     with open(f"./dataset/WikiTQ/{part}.list.json", 'r', encoding='utf-8') as f:
    #         data = json.load(f)

    #     for d in data:
    #         d["table"] = d["table"][0]["table"]
    #     with open(f'./dataset/WikiTQ/{part}.json', 'w', encoding='utf-8') as json_file:
